...
// configuration step. It creates a namespace called `CMakeTemplate`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", CMakeTemplate::cmake::project_name, CMakeTemplate::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", CMakeTemplate::cmake::project_version);
      return EXIT_SUCCESS;
    }
